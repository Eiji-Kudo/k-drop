...
const insOverallTiers = () => {
	...
	insertScoreTier(db, { scoreTierId: "t-silver", tierScope: "overall", tierName: "Silver", minScore: 100, maxScore: 299 });
...
describe("overall と group で別々のティア体系", () => {
	it("overall は Bronze だが group では Gold というケース", () => {
		insOverallTiers();
