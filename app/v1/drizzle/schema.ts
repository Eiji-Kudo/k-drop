...
export const idolGroups = pgTable(
  'idol_groups',
  {
...
export const monthlyScoreHistories = pgTable(
  'monthly_score_histories',
  {
    monthlyScoreHistoryId: serial('monthly_score_history_id')
      .primaryKey()
      .notNull(),
...
export const eventGroupParticipations = pgTable(
  'event_group_participations',
  {
    eventGroupParticipationId: serial('event_group_participation_id')
      .primaryKey()
      .notNull(),
...
export const eventParticipations = pgTable(
  ...
  {
    eventParticipationId: serial('event_participation_id')
      .primaryKey()
      .notNull(),
    eventId: integer('event_id').notNull(),
    appUserId: integer('app_user_id').notNull(),
...
export const rankingTotals = pgTable(
  'ranking_totals',
  {
...
export const userIdolGroupScores = pgTable(
  'user_idol_group_scores',
  {
    userIdolGroupScoreId: serial('user_idol_group_score_id')
      .primaryKey()
      .notNull(),
    appUserId: integer('app_user_id').notNull(),
    idolGroupId: integer('idol_group_id').notNull(),
...
export const quizChoices = pgTable(
  ...
  (table) => [
    index('idx_quiz_choices_quiz_id').using(
      'btree',
